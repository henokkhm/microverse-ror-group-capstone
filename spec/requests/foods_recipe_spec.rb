...
RSpec.describe 'FoodsRecipes', type: :request do
    ...
    let(:recipe) { Recipe.create(id: 1, name: 'Carrot soup', preparation_time: '12 mins', cooking_time: '1 hour', public: true, user:) }
    let(:food) { Food.create(name: 'Carrot', measurement_unit: 'kg', price: 1,
